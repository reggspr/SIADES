        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h2 class="section-heading">Masukkan data transaksi</h2>
                    <hr class="light"><br>
                    <form class="form-horizontal" action="proses-transaksi.php" method="post">
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" rows="3" id="inputKeterangan" name="inputKeterangan" placeholder="Masukkan keterangan transaksi"></textarea>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" id="inputDebit" name="inputDebit" value="0">
                                </div>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                  <div class="input-group-addon">Rp.</div>
                                  <input type="text" class="form-control" id="inputKredit" name="inputKredit" value="0">
                                </div>
                            </div>
                          </div>
